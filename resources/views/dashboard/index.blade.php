                        ...
                        <div class="app-card-header p-3">
                            ...
                            <div>
                                <button type="button" class="btn btn-primary ml-4 mt-4 mb-4 noprint" data-bs-toggle="modal"
                                    data-bs-target="#modalproduk"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                            ...
                            <script type="text/javascript">
                                console.log('test');
                                $('#post-barang').on('submit', function(e) {
                                    $('.btnSaving').hide('fast');
                                    e.preventDefault();
                                    ...
                                    var harga_beli = $('.hargaBeliValue').val();

                                    $.ajax({
                                        url: "{{ url('/barangbaru/create') }}",
                                        type: "post",
                                        dataType: 'json',
                                        data: values,
