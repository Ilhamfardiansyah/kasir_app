            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-12 col-lg-6">
                    <div class="app-card app-card-chart h-100 shadow-sm">
                        ...
                        <div class="mt-4 mb-4 p-4 row">
                            <label for="harga_beli" class="col-sm-3 col-form-label">Harga Suplaier</label>
                            <div class="col-sm-9">
                            ...
                            <label for="inputPassword" class="col-sm-3 mt-2 mb col-form-label">Type Barang</label>
                            <div class="col-sm-9 mt-2">
