    ...
    <div id=" app-sidepanel" class="app-sidepanel">
        ...
        <div class="sidepanel-inner d-flex flex-column">
            ...
            <div class="app-branding">
                <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="/img/logo.png"
                        alt="logo"><span class="logo-text">BAKAS
                        INVENTORY</span></a>
                    ...
                    <li class="nav-item has-submenu">
                        ...
                        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item"><a class="submenu-link" href="help.html">Barang
                                        Masuk</a>
                                </li>
                                ...
                                <li class="submenu-item"><a
                                        class="submenu-link {{ Request::is('dashboard/index') ? 'active' : '' }}"
                                        href="{{ url('/dashboard/index/') }}">Input Barang
                                        Baru</a></li>
                            </ul>
                        </div>
                    </li>
